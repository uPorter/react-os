...
const UnityLoader = () => {
  ...
  return (
    <div className={"unity-instance"}>
      <div style={{ height: '100%', width: '100%', position: 'absolute', backgroundImage: "url(https://react-os-three.vercel.app/img/loader-background.jpg)", backgroundPosition: "center", backgroundRepeat: "no-repeat", backgroundSize: "cover" }}>
        {isStarted === false && (
