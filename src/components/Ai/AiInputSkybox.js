...
const AiInputSkybox = (props) => {
  ...
  const fetchStatus = async () => {
    try {
      const response = await axios.get(url, {
        headers: {
          "x-api-key":
            "5I1laH8NbZhk5xFCoRu5jOHr0p5JruBnxCpfvid8rsWoKNemj9roQUE5HFdG",
        },
      });
      ...
      if (response.data.request.file_url !== "") {
        ...
        window.sendMessageToUnity(
          "skyboxUrlManager",
          "SetURL",
          response.data.request.file_url
        );
  ...
  return (
    <div
      className={`${
        props.aiSkyboxGenClass ? "aiInputHolderIn" : "aiInputHolderOut"
      } aiInputHolder`}
      style={{
        position: "absolute",
    ...
    >
      ...
      {!isAiThinking && <div style={{visibility:"hidden"}} class="spinner">
        <div class="bar1"></div>
        <div class="bar2"></div>
        <div class="bar3"></div>
        <div class="bar4"></div>
      ...
      {isAiThinking && <div class="spinner">
        <div class="bar1"></div>
        <div class="bar2"></div>
        <div class="bar3"></div>
        <div class="bar4"></div>
